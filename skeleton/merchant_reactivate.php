...
if(isset($_POST['reactive_campaign'])){
...
<a href="merchant.php?merchant_id=<?php echo $merchant_id; ?>">< BACK</a> | RE-ACTIVATE <?php echo $campaign_edit['campaign_name']; ?> FOR <?php echo $merchant_name; ?><br>
<br>
<form method="post">
...
<input type="submit" name="reactive_campaign" value="Re-Activate Campaign"><br>
</form>
<?php } ?>
