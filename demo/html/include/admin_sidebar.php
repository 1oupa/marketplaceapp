<div class="sidebar-menu">
        ...
        <ul class="menu-items">
          ...
          <li>
            <a href="javascript:;"><span class="title">Manage Campaigns</span>
            ...
            <ul class="sub-menu">
              ...
              <li class="">
                <a href="calendar_lang.html">View Drafts</a>
                <span class="icon-thumbnail">L</span>
              </li>
              <li class="">
                <a href="calendar_month.html">View Pending Campaigns</a>
                <span class="icon-thumbnail">M</span>
              </li>
              <li class="">
                <a href="calendar_lazy.html">View Active Campaigns</a>
                <span class="icon-thumbnail">La</span>
              </li>
              <li class="">
                <a href="http://pages.revox.io/dashboard/2.1.0/doc/#calendar">View Complete Campaigns</a>
          ...
          <li>
            <a href="javascript:;"><span class="title">Manage Merchants</span>
            <span class=" arrow"></span></a>
            <span class="icon-thumbnail"><i class="pg-layouts2"></i></span>
            <ul class="sub-menu">
              <li class="">
                <a href="default_layout.html">View All Merchants</a>
                <span class="icon-thumbnail">dl</span>
              </li>
              <li class="">
                <a href="secondary_layout.html">Add New Merchant</a>
