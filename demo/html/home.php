          ...
          <div class="jumbotron lg vertical center bg-white column-w4 vertical-bottom" data-pages="parallax">
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20 full-height">
              <div class="inner text-center p-t-50 m-t-80 full-height" style="transform: translateY(9.35px); opacity: 1;">
                ...
                <div class="m-b-10">
                  <h2 class=" p-t-10 inline">Welcome to MarketPlace. The home of exclusive deals.</h2>
                </div>
                <div class="input-group transparent col-md-4 center-margin">
                  <input type="text" class="form-control" placeholder="Search for a city" id="icon-filter" name="icon-filter">
                  <span class="input-group-addon ">
                      <a href="location_deals.php"><i class="pg-search"></i></a> 
                            </span>
                </div>
...
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending Deals </span> in South Africa </h1>
</div>
<div class="hscroll dragscroll p-b-40">
                <!-- <div class="feed"> -->
                  <!-- START DAY -->
                  <!-- <div class="day" data-social="day"> -->
                  <?php foreach(array_slice($view_trending_campaigns,0,4) as $trending_row){
                    $merchant_id = $trending_row['merchant_id'];
                    $merchant_name = $merchants->get_merchant_name($merchant_id);
                    $campaign_name = $trending_row['campaign_name'];
                    $campaign_end = $trending_row['campaign_end'];
                    $campaign_hits = $trending_row['campaign_hits'];
                    $campaign_description = $trending_row['campaign_description'];
                  ?>
                    <form method="post">
                    ...
                    <div class="card share share-other col1" data-social="item">
                        ...
                        <div class="time"><a href="">EXP: <?php echo $campaign_end; ?></a></div>
                        <ul class="reactions">
              ...
              <div class="hscroll dragscroll p-b-40">
                <!-- <div class="feed"> -->
                  <!-- START DAY -->
                  <!-- <div class="day" data-social="day"> -->
                  <?php foreach(array_slice($view_trending_campaigns,4,4) as $trending_row){
                    $merchant_id = $trending_row['merchant_id'];
                    $merchant_name = $merchants->get_merchant_name($merchant_id);
                    $campaign_name = $trending_row['campaign_name'];
                    $campaign_end = $trending_row['campaign_end'];
              ...
              <div class="hscroll dragscroll p-b-40">
                <!-- <div class="feed"> -->
                  <!-- START DAY -->
                  <!-- <div class="day" data-social="day"> -->
                  <?php foreach(array_slice($view_trending_campaigns,8,4) as $trending_row){
                    $merchant_id = $trending_row['merchant_id'];
                    $merchant_name = $merchants->get_merchant_name($merchant_id);
                    $campaign_name = $trending_row['campaign_name'];
                    $campaign_end = $trending_row['campaign_end'];
