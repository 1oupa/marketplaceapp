...
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending</span> Church Experiences <small>(View all)</small></h1>
</div>
              <div class="hscroll dragscroll p-b-40">
                <!-- <div class="feed"> -->
                  <!-- START DAY -->
                  <!-- <div class="day" data-social="day"> -->
                    ...
                    <div class="card share share-other col1" data-social="item">
                      <div class="card-header ">
                        <h5 class="text-default pull-left fs-12">Ministry Name 
                      ...
                      <div class="card-footer clearfix">
                        <div class="time"><a href="">More service times</a></div>
                        <ul class="reactions">
                          <li><a href="#">5,345 <i class="fa fa-eye"></i></a>
                          </li>
...
<!--                             <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
                    ...
                    <div class="card share share-other col1" data-social="item">
                      ...
                      <div class="card-content">
                        <iframe width="298" height="225" src="https://www.youtube.com/embed/EzQCP4CItdc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        <!-- <img alt="Person photo" src="assets/img/social/person-1.jpg"> -->
                      </div>
                      <div class="card-description">
                        <p class="pull-left">Join us every Sunday @ 9AM</p>
...
<!--                             <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
                    ...
                    <div class="card share share-other col1" data-social="item">
                      ...
                      <div class="card-content">
                        <iframe width="298" height="225" src="https://www.youtube.com/embed/1rbacFMaix8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        <!-- <img alt="Person photo" src="assets/img/social/person-1.jpg"> -->
                      </div>
                      <div class="card-description">
                        <p class="pull-left">Join us every Sunday @ 9AM</p>
...
<!--                             <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
                    ...
                    <div class="card share share-other col1" data-social="item">
                      ...
                      <div class="card-content">
                        <iframe width="298" height="225" src="https://www.youtube.com/embed/LKG1TPPKHkw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        <!-- <img alt="Person photo" src="assets/img/social/person-1.jpg"> -->
                      </div>
                      <div class="card-description">
                        <p class="pull-left">Join us every Sunday @ 9AM</p>
...
<!--                             <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
                    ...
                    <div class="card share share-other col1" data-social="item">
                      ...
                      <div class="card-content">
                        <iframe width="298" height="225" src="https://www.youtube.com/embed/ewkESa5vyZY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        <!-- <img alt="Person photo" src="assets/img/social/person-1.jpg"> -->
                      </div>
                      <div class="card-description">
                        <p class="pull-left">Join us every Sunday @ 9AM</p>
...
<!--                             <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
                    ...
                    <div class="card share share-other col1" data-social="item">
                      ...
                      <div class="card-content">
                        <iframe width="298" height="225" src="https://www.youtube.com/embed/pHuPDFQvxHk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        <!-- <img alt="Person photo" src="assets/img/social/person-1.jpg"> -->
                      </div>
                      <div class="card-description">
                        <p class="pull-left">Join us every Sunday @ 9AM</p>
...
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending</span> Church Events <small>(View all)</small></h1>
</div>
              <div class="hscroll dragscroll p-b-40">
                <!-- <div class="feed"> -->
                  <!-- START DAY -->
