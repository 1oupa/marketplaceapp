  ...
  <body class="fixed-header no-header">
    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          <!-- Modals -->
          <div class="modal fade fill-in in" id="modalFillIn" tabindex="-1" role="dialog" aria-hidden="true" >
            ...
            <div class="modal-dialog ">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="text-left p-b-5"><span class="semi-bold">How We Worship</span></h5>
                </div>
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12 ">
                      <iframe width="100%" height="100%" src="https://www.youtube.com/embed/EzQCP4CItdc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width:100%; height:100%;"></iframe>
                    </div>
<!--                     <div class="col-md-3 no-padding sm-m-t-10 sm-text-center">
                  ...
                  <p class="text-right sm-text-center hinted-text p-t-10 p-r-10">Church Name</p>
                </div>
          ...
          <div class="jumbotron lg vertical center bg-white column-w4 vertical-bottom" data-pages="parallax">
            <!-- <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20 full-height"> -->
              <div class="inner text-center p-t-50 m-t-80 full-height" style="transform: translateY(9.35px); opacity: 1;">
                ...
                <div class="m-b-10">
                  <h2 class=" p-t-10 inline"><?php echo strtoupper($campaign_location); ?> DEALS</h2>
                </div>
                <div class="input-group transparent col-md-4 center-margin">
                  <input type="text" class="form-control" placeholder="Search for deals in <?php echo $campaign_location; ?>" id="icon-filter" name="icon-filter">
...
<div class="hscroll dragscroll p-b-40">
...
<?php if($view_location_competitions){?>
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending Competitions </span> in <?php echo ucfirst($campaign_location); ?> <small>(View all)</small></h1>
</div>
<div class="hscroll dragscroll p-b-40">
<?php foreach(array_slice($view_location_competitions,0,$num_deal) as $competitions_row){
  $merchant_id = $competitions_row['merchant_id'];
  $merchant_name = $merchants->get_merchant_name($merchant_id);
  $campaign_name = $competitions_row['campaign_name'];
  $campaign_hits = $competitions_row['campaign_hits'];
  $campaign_end = $competitions_row['campaign_end'];
  $campaign_description = $competitions_row['campaign_description'];
?>
  <!-- <div class="feed"> -->
    <!-- START DAY -->
...
<div class="card share share-other col1" data-social="item">
        <div class="card-header ">
          <h5 class="text-default pull-left fs-12"><?php echo $merchant_name; ?>
            <!-- <i class="fa fa-circle text-complete fs-11"></i> -->
          </h5>
          <div class="pull-right small buttons">
              <!-- <i class="pg-map"></i><a href="#"> Polokwane, South Africa</a> -->
              <!-- <i class="fa fa-comment-o"></i> -->
          </div>
          <div class="clearfix"></div>
        </div>                      
        <div class="" data-toggle="tooltip" title="" data-container="body" data-original-title="Label">
        </div>
        <div class="card-content">                     
          <!-- <iframe width="298" height="225" src="https://www.youtube.com/embed/oTgunrXZBHw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe> -->
          <img alt="Person photo" src="assets/img/social/person-1.jpg">
        </div>
        <!-- <div class="card-description">
          <p class="pull-left">Join us every Sunday @ 9AM</p> -->
          <!-- <div class="dropdown pull-right">
              ...
              <ul class="dropdown-menu pull-right" role="menu">
                ...
                <li><a href="#">Visit Website</a>
                </li>
              </ul>
            </div> -->
        <!-- </div> -->
        <div class="card-footer clearfix">
          <div class="time"> EXP: <?php echo $campaign_end; ?> <i class="fa fa-calendar"></i></div>
          <ul class="reactions">
            <li><a href="#"><?php echo $campaign_hits; ?> <i class="fa fa-eye"></i></a>
            </li>
        ...
        <div class="card-header clearfix">
          ...
          <h5><?php echo $campaign_name; ?></h5><br>
          <p><?php echo $campaign_description; ?></p>
          <!-- <p><i class="pg-map"></i> Get Directions <i class="pg-phone"></i> Call : 082 396 0919</p> -->
          <!-- <div class="text-center m-t-15">
              <button class="btn btn-sm" data-target="#modalFillIn" data-toggle="modal" id="btnFillSizeToggler2">How We Worship</button>
              <button class="btn btn-sm" data-target="#modalFillIn" data-toggle="modal" id="btnFillSizeToggler2">How We Preach</button> -->
            <!-- <a href="" type="button" class="btn btn-default btn-sm btn-cons btn-animated from-top fa fa-arrow-right">
            <span>How We Preach</span>
          </a>  -->
          <!-- </div> -->
          <div class="m-t-15">
          <form method="post">
          ...
          <a href="" type="button" class="btn btn-complete btn-sm btn-block btn-cons btn-animated from-top fa fa-arrow-right">
            <span>See More</span>
          </a>    
          </div>                    
        </div>
...
<?php if($view_location_events){?>
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending Events </span> in <?php echo ucfirst($campaign_location); ?> <small>(View all)</small></h1>
</div>
<div class="hscroll dragscroll p-b-40">
<?php foreach(array_slice($view_location_events,0,$num_deal) as $events_row){
  $merchant_id = $events_row['merchant_id'];
  $merchant_name = $merchants->get_merchant_name($merchant_id);
  $campaign_name = $events_row['campaign_name'];
  $campaign_hits = $events_row['campaign_hits'];
  $campaign_end = $events_row['campaign_end'];
  $campaign_description = $events_row['campaign_description'];
?>
  <!-- <div class="feed"> -->
    <!-- START DAY -->
    <!-- <div class="day" data-social="day"> -->
...
<?php if($view_location_discounts){?>
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending Discounts </span> in <?php echo ucfirst($campaign_location); ?> <small>(View all)</small></h1>
</div>
<div class="hscroll dragscroll p-b-40">
<?php foreach(array_slice($view_location_competitions,0,$num_deal) as $discounts_row){
  $merchant_id = $discounts_row['merchant_id'];
  $merchant_name = $merchants->get_merchant_name($merchant_id);
  $campaign_name = $discounts_row['campaign_name'];
  $campaign_hits = $discounts_row['campaign_hits'];
  $campaign_end = $discounts_row['campaign_end'];
  $campaign_description = $discounts_row['campaign_description'];
?>
  <!-- <div class="feed"> -->
    <!-- START DAY -->
    <!-- <div class="day" data-social="day"> -->
...
<?php if($view_location_promotions){?>
<div class="m-l-10">
<h1 class="text-black"><span class="semi-bold">Trending Promotions </span> in <?php echo ucfirst($campaign_location); ?> <small>(View all)</small></h1>
</div>
<div class="hscroll dragscroll p-b-40">
<?php foreach(array_slice($view_location_promotions,0,$num_deal) as $promotions_row){
  $merchant_id = $promotions_row['merchant_id'];
  $merchant_name = $merchants->get_merchant_name($merchant_id);
  $campaign_name = $promotions_row['campaign_name'];
  $campaign_hits = $promotions_row['campaign_hits'];
  $campaign_end = $promotions_row['campaign_end'];
  $campaign_description = $promotions_row['campaign_description'];
?>
  <!-- <div class="feed"> -->
    <!-- START DAY -->
    <!-- <div class="day" data-social="day"> -->
