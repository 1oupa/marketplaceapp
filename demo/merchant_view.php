...
if(isset($_POST['other_deal_view'])){
    $campaign_id = $_POST['campaign_id'];
    $campaign_hits = ($_POST['campaign_hits'])+1;
...
<a href="merchant.php?merchant_id=<?php echo $merchant_id;?>">< BACK</a><br>
...
<!-- OTHER <?php //echo strtoupper($merchant_name); ?> DEALS -->
...
<input type="submit" name="other_deal_view" value="<?php echo $other_deals['campaign_name'];?>">
<?php //}?>
